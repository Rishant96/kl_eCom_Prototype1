    ...
    public class CustomerController : Controller
    {
        ...
        public ActionResult Cancellation(CustomerCancellationViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string message = "Cancellation request has been generated by " + order.Customer.FirstName
                        + " " + order.Customer.LastName + ", for the following items:\n\n";
                ...
                for (int i = 0; i < cnclsList.Count(); i++)
                {
                    ...
                    tempMessage += "\nContact customer at: " + order.Customer.PhoneNumber + "\n\n";
                    tempMessage += "Regards,\nKhuslife E-com Team";

                    FireEmail(orderItm.Vendor.Email, subject, message + tempMessage);
                }
